...
- **Registration Endpoint:** `https://mzfortech.com/oauth/register`
...
- **Token Endpoint:** `https://mzfortech.com/oauth/token`

## Revocation
To revoke access:
- **Revocation Endpoint:** `https://mzfortech.com/oauth/revoke`
